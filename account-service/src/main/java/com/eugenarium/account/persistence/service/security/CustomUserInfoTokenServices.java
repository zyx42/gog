 ...
 * return clientId and scope of calling service. This information used in controller's security checks.
 */
public class CustomUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    private Map<String, Object> getMap(String path, String accessToken) {
        ...
        try {
            ...
            LOGGER.info("Could not fetch user details: " + e.getClass() + ", " + e.getMessage());
    ...
    private OAuth2Request getRequest(Map<String, Object> map) {
        ...
        String clientId = (String) request.get("cliendId");
